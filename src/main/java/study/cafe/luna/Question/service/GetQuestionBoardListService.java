...
public class GetQuestionBoardListService {

	// 문의글 목록보기
//	public List<QuestionBoardDTO> QboardList(int start, int end, String searchOption, String keyword, String branchName)
//			throws Exception;
