...
//	public String eventView(MemberCommand memcom, HttpSession session, HttpServletRequest
////	  request) { 
//			Map<String, ?> flashMap=RequestContextUtils.getInputFlashMap(request); 
//	if(flashMap!=null) {
//	  memcom.setId(flashMap.get("id").toString()); session.setAttribute("member",memcom); }else { memcom=(MemberCommand)session.getAttribute("member"); 
//	}
